            ...
            <div class="col-4">
                <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                    <div class="px-3 pt-3">
                        ...
                        @php
                            $pending_orders = DB::table('orders')->join('order_details', 'orders.id', '=', 'order_details.order_id')->where('order_details.delivery_status', 'pending')->select('orders.id')->distinct()->get()->count();
                        @endphp
            ...
            <div class="col-4">
                <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
                    <div class="px-3 pt-3">
                        ...
                        @php
                            $delivered_orders = DB::table('orders')->join('order_details', 'orders.id', '=', 'order_details.order_id')->where('order_details.delivery_status', 'delivered')->select('orders.id')->distinct()->get()->count();
                        @endphp
        ...
        <div class="row gutters-10">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <canvas id="pie-1" class="w-100" height="290"></canvas>
                    </div>
                </div>
            </div>
            <!-- <div class="col-6">
...
@endif
    ...
    <div class="row gutters-10">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0 fs-14"> Update List</h6>
                </div>
                <div class="card-body">
                        <div class="list-group">
                          ...
                          <button type="button" class="list-group-item list-group-item-action">Customer Data Edit</button>
                          <button type="button" class="list-group-item list-group-item-action">Orders Data Edit</button>
                          <button type="button" class="list-group-item list-group-item-action">Order Search By customer name or number</button>
                          <button type="button" class="list-group-item list-group-item-action" >Faq Page</button>
                           <button type="button" class="list-group-item list-group-item-action" disabled>Blog</button>
                            <button type="button" class="list-group-item list-group-item-action" disabled>Print Invoice Size</button>
                             <button type="button" class="list-group-item list-group-item-action" disabled>Live Product Search</button>
                             <button type="button" class="list-group-item list-group-item-action" disabled>Unit Update from order view</button>
                        </div>
                </div>
            </div>
        </div>
