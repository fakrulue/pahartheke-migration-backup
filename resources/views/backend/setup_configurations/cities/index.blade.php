        ...
        <div class="col-md-5">
    		<div class="card">
    			<div class="card-header">
    				<h5 class="mb-0 h6">{{ translate('Multiple city shipping cost set') }}</h5>
    			</div>
    			<div class="card-body">
    				<form action="{{ route('cities.bulk_cost') }}" method="POST">
    					@csrf

                        <div class="form-group">
                            <label for="country">{{translate('Cities')}}</label>
                            <select class="select2 form-control aiz-selectpicker" name="cities[]" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true" data-actions-box="true" data-selected-text-format="count" required multiple >
