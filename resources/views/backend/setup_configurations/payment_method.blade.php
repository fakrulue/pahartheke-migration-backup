    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header ">
                    <h5 class="mb-0 h6">{{translate('Aamar Pay Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        @csrf
                        <input type="hidden" name="payment_method" value="aamar_pay">
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="AAMARPAY_MERCHENT_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('AAMARPAY MERCHENT ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="AAMARPAY_MERCHENT_ID" value="{{  env('AAMARPAY_MERCHENT_ID') }}" placeholder="{{translate('AAMARPAY MERCHENT ID')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="aamar_pay_sandbox" type="checkbox" @if (\App\BusinessSetting::where('type', 'aamar_pay_sandbox')->first()->value == 1)
                                        checked
                                    @endif>
                                    <span class="slider round"></span>
                                </label>
