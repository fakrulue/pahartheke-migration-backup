                        ...
                        <tbody>
                            @foreach ($order->orderDetails as $key => $orderDetail)
                                <tr>
                                    ...
                                    <td>{{ single_price($orderDetail->price - $orderDetail->discount) }}</td>
                                    @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                                        @php
                    ...
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-right">
                                    <span class="strong-600">{{ single_price($order->orderDetails->sum('price') - $order->total_discount) }}</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    @endphp
                                    <span class="text-italic">{{ single_price($get_shipping_cost->shipping_cost) }}</span>
                                </td>
                            </tr>
                            <tr>
