...
<head>
    ...
    <!-- <meta name="google-site-verification" content="google03e106d952607f75" /> -->
...
@if (\App\BusinessSetting::where('type', 'facebook_pixel')->first()->value == 1)
    ...
    <noscript>
        <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=45345345/&ev=PageView&noscript=1"/>
    </noscript>
...
})(window,document,'script','dataLayer','GTM-MTRXSTQ');</script>
<!-- End Google Tag Manager -->


<script async src="https://www.googletagmanager.com/gtag/js?id=G-1R0X0QZTC6"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-1R0X0QZTC6');
</script>
<style>
@keyframes spin {
                ...
                if(checkAddToCartValidity()) {
                    ...
                    $.ajax({
                       ...
                       success: function(data){
                           ...
                           updateNavCart();
                           $('#cart_items_sidenav').html(parseInt($('#cart_items_sidenav').html())+1);
                           window.location = "https://pahartheke.com/easy-checkout";
                       }
                   });
                }
                else{
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MTRXSTQ"
