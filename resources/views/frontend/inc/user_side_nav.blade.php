    ...
    <div class="aiz-user-sidenav rounded overflow-hidden  c-scrollbar-light">
        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('affiliate_history.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['affiliate_history.index'])}}">
                        <i class="las la-file-alt aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('affiliate Dashboard') }}</span>
                    </a>
                </li>

                <li class="aiz-side-nav-item">
                    <a href="{{ route('withdraw.list') }}" class="aiz-side-nav-link {{ areActiveRoutes(['withdraw.list'])}}">
                        <i class="las la-file-alt aiz-side-nav-icon"></i>
