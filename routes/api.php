...
Route::get('v1/get-category-city-product', 'CrmApiController@index');
...
Route::prefix('v3')->group(function () {
    Route::get('get-category-city-product', 'CrmApiController@index');
    Route::get('customers', 'CrmApiController@customers');
});

//for pos
Route::prefix('v4')->group(function () {
    Route::get('get-category-product', 'CrmApiController@index2');
    Route::get('customers', 'CrmApiController@customers');
    Route::get('units', 'CrmApiController@products');
});
